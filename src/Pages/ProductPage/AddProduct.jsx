...
export default function AddProduct() {
    ...
    const UploadProduct = async (e) => {
        e.preventDefault();
        if (!name || !price || !category || !stock || !image || !sex || !brand || !description) {
    ...
    return (
        <div>
            <section className='h-full w-full lg:px-10  '>
                <div className='w-full flex md:flex-row flex-col gap-21 justify-between md:items-center'>
                ...
                <section className='grid lg:grid-cols-2 gap-5 py-5 h-full'>
                    <div className='bg-gray-50 h-[400px] rounded-2xl py-5 px-5'>
                        ...
                        <form className='flex gap-5 flex-col h-full py-3 '>
                            <div className='flex flex-col'>
                                <label htmlFor="name" className='lg:text-lg text-sm'>Product name</label>
                                <input
                                    type="text"
                                    id='name'
                                    value={name}
                    ...
                    <div className='rounded-2xl'>
                        <section className='grid grid-cols-1 gap-3 h-full'>
                            <div className="bg-gray-50 rounded-md py-5 px-5">
                                <h1 className="lg:text-xl text-sm font-semibold">Product's Image</h1>
                    ...
                    <div className={`${disable ? "hidden" : "bg-gray-50 rounded-2xl px-5"}`}>
                        <h1 className='lg:text-xl text-sm'>Available Product Sizes</h1>
                    ...
                    <div className='bg-gray-50 flex rounded-2xl px-5 gap-4'>
                        <div>
                            <h1 className='lg:text-xl text-sm'>Stock</h1>
                        ...
                        <div>
                            <h1 className='lg:text-xl text-sm'>Brand</h1>
                            <form action="" className='py-5'>
                                <div className='flex gap-5'>
                                    <input
                                        required
                    ...
                    <div className='bg-gray-50 flex flex-col py-5 rounded-2xl px-5'>
                        <h1 className='lg:text-xl text-sm'>Sex</h1>
                        <p className='lg:text-sm text-xs text-gray-600'>Select sex for the product [male, female]</p>
